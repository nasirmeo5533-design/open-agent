...
The repo also carries flat static pages (`about.html`, `services.html`, `pricing.html`, `portfolio.html`, `case-studies.html`, `refund.html`, `terms.html`, `privacy.html`, `faq.html`, `slides.html`) with `assets/css/style.css`, `assets/js/main.js`, and a `blog/` folder of standalone post HTML files, plus `vercel.json` redirects for legacy asset paths.
