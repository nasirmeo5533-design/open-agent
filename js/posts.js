  ...
  window.POSTS = {
    ...
    "automation": {
      ...
      body: [
        ...
        { t: "p", v: "I ran this exact setup for a fashion store in Karachi. Order-status messages dropped to zero manual sends. The AI agent answered most support questions on its own. The owner stopped asking how the previous day went because the answer arrived before he did. Weekly manual work fell to a fraction of what it was." },
